...
export const translations = {
  en: {
    ...
    landing: {
      ...
      // ── v3.0 photo-first landing page keys ──
      navFeatures: "Features",
      navPricing: "Pricing",
      navCta: "Try Free",
      heroBadgeV3: "Management tool built for hostels",
      heroTitle1V3: "Ditch the spreadsheets.",
      heroTitle2V3: "See every bed at a glance.",
      heroSubtitleV3: "Visual bed board, one-click check-in, direct booking link. Built for small hostels under 50 beds. $19/month.",
      heroTrust1: "Trusted by 5+ hostels",
      heroTrust2: "Supports Booking.com / Airbnb / Walk-in",
      painEyebrow: "The reality of running a hostel",
      mockupCallout: "Drag to swap beds",
      mockupTitle: "BunkDesk — Bed Board",
      mockupBedHeader: "Bed",
      mockupToday: "Today",
      mockupRoom101: "101 · 6-bed",
      mockupRoom201: "201 · 8-bed",
      mockupQuickBook: "+ Quick book",
      feat1Badge: "Core Feature",
      feat1TitleV3: "Visual Bed Board",
      feat1Subtitle: "See every bed at a glance",
      feat1DescV3: "No more digging through spreadsheets. Gantt-style timeline shows every bed, every room, every day. Drag to swap, resize to adjust dates — as easy as a calendar.",
      feat1Row1Title: "Drag to check-in / swap",
      feat1Row1Desc: "Drop a guest block onto a bed — conflicts auto-detected",
      feat1Row2Title: "Color = status",
      feat1Row2Desc: "Blue paid, amber pending, green reserved, red conflict",
      feat1Row3Title: "Smart bed suggestions",
      feat1Row3Desc: "Auto-matches by gender, preference, and price",
      feat2Badge: "Direct Booking",
      feat2TitleV3: "Your own booking page",
      feat2Subtitle: "0% commission",
      feat2DescV3: "OTAs take 15–20% per booking. We give you a link — guests book direct, pay direct, and auto-appear on your bed board. The savings pay for BunkDesk for a year.",
      feat2Row1Title: "One-click booking link",
      feat2Row1Desc: "Share on WhatsApp, Instagram, your site — guests scan to book",
      feat2Row2Title: "Auto-sync to bed board",
      feat2Row2Desc: "New bookings appear instantly — no manual entry",
      feat2Row3Title: "Online payments",
      feat2Row3Desc: "Stripe / PayPal supported — auto-marked \"paid\"",
      feat3Badge: "Team Collaboration",
      feat3TitleV3: "Shift handover without",
      feat3Subtitle: "WhatsApp messages",
      feat3DescV3: "The worst part of shift changes is lost info. BunkDesk has a built-in shift log: who checked in, who checked out, who hasn't paid, special requests. The next staffer opens it and sees everything.",
      feat3Row1Title: "Shift log",
      feat3Row1Desc: "Check-ins, check-outs, repairs, complaints — categorized, nothing lost",
      feat3Row2Title: "Role-based permissions",
      feat3Row2Desc: "Owner sees all, reception checks in, cleaner sees tasks",
      feat3Row3Title: "Guest notes & memos",
      feat3Row3Desc: "Who needs a bottom bunk, who's arriving late — jot it down, team sees it",
      feat4Badge: "Data-Driven",
      feat4TitleV3: "Know how much",
      feat4Subtitle: "each bed earned",
      feat4DescV3: "Beyond occupancy. BunkDesk tracks true revenue per bed, empty-bed losses, cleaning costs. Should you raise weekend prices? Which room sells best? The data answers.",
      feat4Row1Title: "Bed revenue analytics",
      feat4Row1Desc: "Top bunk vs bottom bunk, occupancy by price tier",
      feat4Row2Title: "Empty-bed loss tracking",
      feat4Row2Desc: "Hidden losses you'd never spot with room-level management",
      feat4Row3Title: "Cleaning status tracking",
      feat4Row3Desc: "Checkout auto-creates cleaning tasks, cleaner marks done",
      ctaTitleV3: "14-day free trial. No credit card.",
      ctaSubtitleV3: "Set up in an afternoon.",
      ctaButtonV3: "Try Free",
      ctaTrust1: "No credit card",
      ctaTrust2: "Set up afternoon, use tonight",
      ctaTrust3: "Email support",
    },
    subnav: {
      overview: "Overview",
      grow: "Grow",
    ...
    checkin: {
      ...
      confirmAutoAssignTitle: "Confirm auto-assignment",
      confirmAutoAssignSubtitle: "Review the recommended bed before checking in",
  ...
  zh: {
    ...
    landing: {
      ...
      navPricing: "定价",
      navCta: "免费试用",
      heroBadgeV3: "专为青旅打造的管理工具",
      heroTitle1V3: "告别表格",
      heroTitle2V3: "看清每一张床位",
      heroSubtitleV3: "可视化床位看板、一键入住、直销预订链接。专为 50 张床位以下的小型青旅设计，每月 $19。",
      heroTrust1: "已有 5+ 青旅在使用",
      heroTrust2: "支持 Booking.com / Airbnb / Walk-in",
      painEyebrow: "经营青旅的现实",
      mockupCallout: "拖拽即可换床",
      mockupTitle: "BunkDesk — 床位看板",
      mockupBedHeader: "床位",
      mockupToday: "今天",
      mockupRoom101: "101 · 6人间",
      mockupRoom201: "201 · 8人间",
      mockupQuickBook: "+ 快速预订",
      feat1Badge: "核心功能",
      feat1TitleV3: "可视化床位看板",
      feat1Subtitle: "一眼看清每张床",
      feat1DescV3: "不再翻表格。甘特图式时间线，每张床位、每个房间、每天状态一目了然。拖拽换床、边缘调整日期，就像操作日历一样简单。",
      feat1Row1Title: "拖拽入住 / 换床",
      feat1Row1Desc: "拖动客人色块到目标床位，自动检测冲突",
      feat1Row2Title: "颜色 = 状态",
      feat1Row2Desc: "蓝色已付、琥珀待付、绿色已预订、红色冲突",
      feat1Row3Title: "智能推荐床位",
      feat1Row3Desc: "根据性别、偏好、价格自动匹配最佳床位",
      feat2Badge: "直销预订",
      feat2TitleV3: "你的专属预订页",
      feat2Subtitle: "0% 佣金",
      feat2DescV3: "OTA 每单抽 15-20%。我们给你一个链接，客人直接预订、直接付款、自动出现在床位看板上。省下来的钱够付 BunkDesk 一整年。",
      feat2Row1Title: "一键生成预订链接",
      feat2Row1Desc: "分享到微信、Instagram、网站，客人扫码即可预订",
      feat2Row2Title: "自动同步到床位看板",
      feat2Row2Desc: "客人订完立刻显示，不用手动录入",
      feat2Row3Title: "在线收款",
      feat2Row3Desc: "支持 Stripe / 支付宝，到账自动标记\"已付\"",
      feat3Badge: "团队协作",
      feat3TitleV3: "交接班不再",
      feat3Subtitle: "靠微信消息",
      feat3DescV3: "前台换班时最怕信息断层。BunkDesk 内置交接日志：谁入住、谁退房、谁还没付款、有什么特殊需求。下一个同事打开就能看到全部。",
      feat3Row1Title: "交接日志",
      feat3Row1Desc: "入住、退房、维修、投诉——分类记录，不会遗漏",
      feat3Row2Title: "权限分级",
      feat3Row2Desc: "老板看全部、前台操作入住、保洁员看清洁任务",
      feat3Row3Title: "客人备注 & 便签",
      feat3Row3Desc: "谁怕冷需要下铺、谁晚到——随手记，全员可见",
      feat4Badge: "数据驱动",
      feat4TitleV3: "知道每张床",
      feat4Subtitle: "赚了多少",
      feat4DescV3: "不只看入住率。BunkDesk 帮你追踪每张床的真实收入、空床损失、清洁成本。周末该涨价吗？哪间房卖得最好？数据告诉你答案。",
      feat4Row1Title: "床位收入分析",
      feat4Row1Desc: "上铺 vs 下铺、不同价位段的入住对比",
      feat4Row2Title: "空床损失追踪",
      feat4Row2Desc: "按\"房间\"管理永远发现不了的隐性损失",
      feat4Row3Title: "清洁状态追踪",
      feat4Row3Desc: "退房自动生成清洁任务，保洁完成后自动标记",
      ctaTitleV3: "14 天免费试用 无需信用卡",
      ctaSubtitleV3: "一整个下午就能搭好",
      ctaButtonV3: "免费试用",
      ctaTrust1: "无需信用卡",
      ctaTrust2: "下午搭好，晚上使用",
      ctaTrust3: "中文客服支持",
    ...
    checkin: {
      ...
      confirmAutoAssignTitle: "确认自动分配",
      confirmAutoAssignSubtitle: "请确认推荐的床位后办理入住",
      bestMatch: "最佳匹配",
      whyThisBed: "推荐原因",
      vsAvg: "对比均价",
